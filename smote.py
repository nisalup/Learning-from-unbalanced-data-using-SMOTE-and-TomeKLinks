...
print('counts of labels before oversampling: ', unique, count)
...
print('counts of labels after oversampling: ', unique1, count1)
...
pd.DataFrame(Z2).to_csv('smote_test_data_predict.csv')
pd.DataFrame(probas).to_csv('smote_test_data_predict_probabilities.csv')
plt.show()